...
const footerNavigation = {
  main: [
    { name: 'About', href: 'https://github.com/AnasAito' },
    { name: 'Blog', href: 'https://anasaitaomar1999.medium.com/' },
    { name: 'Projects', href: 'https://github.com/AnasAito' },
    { name: 'Contact', href: 'https://twitter.com/anas_aito' },
  ],
  social: [
    {
      name: 'Twitter',
      ...
      <footer className="mt-24 bg-gray-900 sm:mt-12">
        <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; 2022 Anas_aito (Anas AIT AOMAR). All rights reserved.
          </p>
        </div>
      </footer>
    </div>
